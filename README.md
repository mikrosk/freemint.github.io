...
- [FreeMiNT and XaAES](https://github.com/mikrosk/freemint.github.io/tree/master/builds/freemint/master/new); alternate builds available (with the original file tree structure as on [freemint.org](http://freemint.org)), i.e. binaries for all CPU combinations:
